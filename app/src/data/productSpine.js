...
export const ROUTE_META = Object.freeze({
  ...
  '/trailer': {
    ...
    loopStep: 'observe',
    purpose: 'Show real Plundrix gameplay and live-network proof.',
    title: 'Plundrix Gameplay Trailer - 32 Seconds',
    description: 'Watch the Plundrix lobby, active vault, simultaneous resolution, replay art, and a completed funded Sepolia operation in 32 seconds.',
