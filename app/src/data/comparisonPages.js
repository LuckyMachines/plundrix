...
export const COMPARISON_PAGES = Object.freeze([
  ...
  {
    slug: 'online-strategy-board-game',
    competitor: 'Traditional online board games',
    category: 'Online strategy games',
    eyebrow: 'Online strategy board game',
    title: 'Plundrix as an Online Strategy Board Game',
    metaTitle: 'Online Strategy Board Game: Plundrix Vault Tactics',
    metaDescription: 'Plundrix is a board-game-like online vault race with short sessions, visible sabotage, replays, leaderboards, and clearly labeled agents.',
    headline: 'An online strategy board game built around short vault races and sharp table reads.',
    summary: 'Plundrix is closest to a compact online board game: players join a table, make turn-based action choices, pressure the leader, and finish with a visible winner. Saved session history and replays make each match easy to review.',
    bestFor: [
      'Players looking for an online game with readable match structure.',
      'Board-game fans who want short online sessions.',
      'Players interested in readable match records and replays.',
    ],
    notFor: [
    ...
    plundrixAdvantages: [
      'Hosted sessions begin without account or payment setup.',
    ...
    compareRows: [
      ['Primary promise', 'Usually classic board-game recreation or asynchronous play.', 'Original short-session vault-heist strategy.'],
    ...
    faq: [
      ['Is Plundrix fully hosted?', 'Yes. Plundrix handles live-table setup and move processing through its game service, while practice tables, replays, and leaderboards support the player experience.'],
      ...
      ['Why call it an online board game?', 'Because the session shape is table-based, turn-based, and stateful, with a saved game record and board-game-like player decisions.'],
    ],
    sourceLinks: [
  ...
  },
  {
    ...
    category: 'Online RPG alternatives',
    eyebrow: 'Pirate Nation alternative',
    title: 'Plundrix vs Pirate Nation',
    metaTitle: 'Pirate Nation Alternative: Plundrix Session Strategy',
    metaDescription: 'Compare Pirate Nation-style RPG progression with Plundrix, a shorter session-based vault race with sabotage, replays, and readable match records.',
    headline: 'A Pirate Nation alternative for players who want focused table competition.',
    summary: 'Pirate Nation represents a broader RPG and progression direction. Plundrix is narrower by design: short competitive vault sessions, readable sabotage, leaderboards, and replays.',
    bestFor: [
      'Players curious about online RPGs but wanting a shorter session loop.',
      'Competitive players who prefer a clear match winner.',
      'Players who want readable matches and replayable finishes.',
    ],
    notFor: [
    ...
    plundrixAdvantages: [
      ...
      'Status screens that make table and session health visible.',
    ],
    compareRows: [
      ...
      ['Match tools', 'Broader RPG progression tools.', 'Practice tables, agents, replays, and rule previews around one match format.'],
    ],
    faq: [
      ['Is Plundrix a Pirate Nation clone?', 'No. Plundrix is a vault-heist board-game-like strategy session with a very different scope and loop.'],
      ['Which is more competitive?', 'Plundrix is explicitly centered on short competitive sessions and leaderboard-ready outcomes.'],
      ['Why compare these games at all?', 'Both can appeal to players looking for stylized online adventures, progression, and memorable rivalries.'],
    ],
    sourceLinks: [
