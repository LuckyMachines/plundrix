...
export default function InstantPlayPage() {
  ...
  if (!started) {
    return (
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        <Seo title="Play Plundrix Instantly" description="Start a fast Plundrix vault race against named tactical agents. No wallet required." path="/play" />
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
      <Seo title={`${MODES[mode].label} Operation - Plundrix`} description="Play a fast tactical Plundrix vault race." path="/play" />
