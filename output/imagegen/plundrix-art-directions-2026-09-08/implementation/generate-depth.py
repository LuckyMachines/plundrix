"""Reproduce relative-depth evidence for the implemented caper system."""
...
INPUTS = {
    "APPROVED SYNTHESIS": STUDY_DIR / "05-recommended-synthesis.png",
    "IMPLEMENTED PRODUCT": REPO_ROOT
...
def main() -> None:
    ...
    for label, path in INPUTS.items():
        ...
        slug = "reference" if label.startswith("APPROVED") else "implementation"
