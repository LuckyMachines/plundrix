...
ARG VITE_WORKSHOP_ADDRESS
ARG VITE_SESSION_RELAY_URL
ARG VITE_ENABLE_STAKES=false
ARG VITE_ENABLE_NEXT_RULES=false
ARG VITE_ENABLE_TABLE_PRESSURE=false
...
ENV VITE_CONTRACT_ADDRESS=$VITE_CONTRACT_ADDRESS \
    ...
    VITE_WORKSHOP_ADDRESS=$VITE_WORKSHOP_ADDRESS \
    VITE_SESSION_RELAY_URL=$VITE_SESSION_RELAY_URL \
    VITE_ENABLE_STAKES=$VITE_ENABLE_STAKES \
    VITE_ENABLE_NEXT_RULES=$VITE_ENABLE_NEXT_RULES \
    VITE_ENABLE_TABLE_PRESSURE=$VITE_ENABLE_TABLE_PRESSURE \
